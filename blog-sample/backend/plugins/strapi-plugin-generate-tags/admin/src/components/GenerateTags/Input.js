...
export function Input({ icon, name, disabled, autoFocus, onChange, onBlur, onFocus, placeholder, value, inputDescription, validations, onClick, error }) {
    ...
    <InputWrapper className="col-md-12">
      <InputGroupWrapper>
        ...
        <InputButton onClick={onClick}>
          <i className={icon} role="button" aria-hidden="true" />
        </InputButton>
      </InputGroupWrapper>
      <InputDescription
